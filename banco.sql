...
--insert into tb_login(id, cpf, email, senha, tipo, situacao, dtcadastro,dtmodificacao)
						 value(null, '11872318789','thiagoramonfp@hotmail.com',sha1('thi-amuito'), 'A','A', sysdate(), sysdate() );
-- ADM login adm
-- USER login public
